...
public class TileEntityHopperFast extends TileEntityHopper implements Hopper {
    ...
    private static ItemStack func_102014_c(IInventory par0IInventory, ItemStack par1ItemStack, int par2, int par3) {
        ...
        if (func_102015_a(par0IInventory, par1ItemStack, par2, par3)) {
            ...
            if (flag) {
                if (par0IInventory instanceof TileEntityHopperFast) {
                    ((TileEntityHopperFast)par0IInventory).setTransferCooldown(1);
                }
